...
ALTER TABLE "product" DROP COLUMN "updated_at";--> statement-breakpoint
ALTER TABLE "product_variant" DROP COLUMN "updated_at";--> statement-breakpoint
ALTER TABLE "shipping_address" DROP COLUMN "updated_at";